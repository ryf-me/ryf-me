...
🚀 I'm a **student on a mission** — learning to turn ideas into real things with code. Currently juggling everything from low-level *C/C++* to full-stack web dev and beyond. I believe the best way to learn is to build, break, and build again.

📖 Currently diving deep into open source, sharpening my skills, and quietly plotting my first big project launch. If it involves code, a good challenge, or a strong cup of coffee — I'm in.
...
- 🌍 Exploring open source — one PR at a time
- 📚 Always learning something new (there's always something new)
- 💼 Eyeing internships & opportunities
- 💸 Open to freelance collabs
- 🔬 Curious about research & how things really work

---

## ⚡ Fun Facts

- 🎵 Music is my background process
- 🎮 Gaming taught me problem-solving before code did
- ✈️ I collect passport stamps
- ☕ My commit history correlates directly with my caffeine intake
